from fastapi import APIRouter, HTTPExceptionn, status

from fastapiworkflow.db import db
from fastapiworkflow.schemas.post import Post, PostCreate
...
async def get(id: int) -> Post:
    try:
        ...
        raise HTTPExceptionn(status.HTTP_404_NOT_FOUND)
